...
ctrl.controller('TrackViewController', ['$rootScope', '$scope', '$state', '$stateParams', '$ionicPopup', '$translate', 'TrackStorage', 'SettingsService', 'track', function ($rootScope, $scope, $state, $stateParams, $ionicPopup, $translate, TrackStorage, SettingsService, track) {
